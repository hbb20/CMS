...
Public Class Marksheet_level2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CMS.Marksheet_level2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarksheet_level2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Marksheet_level2 = New Marksheet_level2()
        rpt.Site = Me.Site
        Return rpt
    End Function
