...
Public Class Marksheet_level4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CMS.Marksheet_level4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarksheet_level4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Marksheet_level4 = New Marksheet_level4()
        rpt.Site = Me.Site
        Return rpt
    End Function
