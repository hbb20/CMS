...
Public Class Marksheet_level1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CMS.Marksheet_level1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarksheet_level1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Marksheet_level1 = New Marksheet_level1()
        rpt.Site = Me.Site
        Return rpt
    End Function
