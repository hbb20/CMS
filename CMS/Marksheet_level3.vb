...
Public Class Marksheet_level3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CMS.Marksheet_level3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMarksheet_level3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Marksheet_level3 = New Marksheet_level3()
        rpt.Site = Me.Site
        Return rpt
    End Function
